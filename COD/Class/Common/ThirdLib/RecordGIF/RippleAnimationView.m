...
- (CALayer *)pulsingLayer:(CGRect)rect animation:(CAAnimationGroup *)animationGroup {
    ...
    if (_animationType == AnimationTypeWithBackground) {
        pulsingLayer.backgroundColor = ColorWithAlpha(4, 126, 245, 0.5).CGColor;
        pulsingLayer.borderWidth = 0.5;
    } else {
        pulsingLayer.borderWidth = 1.f;
    }
    
    pulsingLayer.borderColor = ColorWithAlpha(4, 126, 245, 0.5).CGColor;
...
- (CAKeyframeAnimation *)backgroundColorAnimation {
    ...
    backgroundColorAnimation.values = @[(__bridge id)ColorWithAlpha(4, 126, 245, 0.5).CGColor,
                                        (__bridge id)ColorWithAlpha(151, 213, 255, 0.5).CGColor,
                                        (__bridge id)ColorWithAlpha(199, 232, 255, 0.5).CGColor,
                                        (__bridge id)ColorWithAlpha(199, 232, 255, 0).CGColor];
...
- (CAKeyframeAnimation *)borderColorAnimation {
    ...
    borderColorAnimation.values = @[(__bridge id)ColorWithAlpha(4, 126, 245, 0.5).CGColor,
                                    (__bridge id)ColorWithAlpha(151, 213, 255, 0.5).CGColor,
                                    (__bridge id)ColorWithAlpha(199, 232, 255, 0.5).CGColor,
                                    (__bridge id)ColorWithAlpha(199, 232, 255, 0).CGColor];
