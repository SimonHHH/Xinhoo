...
- (void)keyboardWillShow:(NSNotification *)notification {
    ...
    [UIView animateWithDuration:keyboardAnimationDuration delay:keyboardAnimationDuration options:keyboardAnimationCurve animations:^{
        self.textView.frame = CGRectMake( self.textView.frame.origin.x, kTopOffset, self.textView.frame.size.width, [UIScreen mainScreen].bounds.size.height - keyboardRect.size.height - kTextTopOffset);
...
- (void)keyboardWillHide:(NSNotification *)notification {
    ...
    [UIView animateWithDuration:keyboardAnimationDuration delay:0.f options:keyboardAnimationCurve animations:^{
        self.frame = CGRectMake( self.frame.origin.x, self.effectView.frame.size.height + kTopOffset, self.frame.size.width, self.frame.size.height);
